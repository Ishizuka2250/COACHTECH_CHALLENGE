@if ($paginator->hasPages())
    <nav role="navigation" aria-label="{{ __('Pagination Navigation') }}" class="navigation-outer">
        ...
        <div class="pagenation">
            <div>
                <p class="text-sm text-gray-700 leading-5">
                    <span class="font-medium">全{{ $paginator->total()}}件中 {{ $paginator->firstItem()}}～{{ $paginator->lastItem() }}件</span>
                </p>
            </div>
